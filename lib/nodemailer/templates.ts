...
export const SIGNIN_EMAIL_TEMPLATE = `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Security Alert — New Sign-in to Your Signalist Account</title>
  <style>
    body { font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; background:#050505; color:#CCDADC; }
    .container { max-width:600px; margin:32px auto; background:#141414; padding:28px; border-radius:8px; border:1px solid #30333A; }
    .title { color:#FDD458; font-size:20px; font-weight:600; margin-bottom:12px }
    .muted { color:#9ca3af; }
    .cta { display:inline-block; margin-top:16px; padding:12px 18px; background:linear-gradient(135deg,#FDD458,#E8BA40); color:#000; border-radius:8px; text-decoration:none; }
    .info { background:#0b0b0b; padding:12px 14px; border-radius:6px; border:1px solid #222; color:#e5e7eb; }
  </style>
</head>
<body>
  <div class="container">
    <div class="title">Security notice</div>
    <div class="muted">We detected a sign-in to your Signalist account.</div>

    <div class="info" style="margin-top:16px;">
      <p style="margin:0 0 8px 0"><strong>Account:</strong> {{email}}</p>
      <p style="margin:0 0 8px 0"><strong>Time:</strong> {{time}}</p>
      <p style="margin:0 0 8px 0"><strong>IP Address:</strong> {{ip}}</p>
      <p style="margin:0"><strong>Device/Agent:</strong> {{userAgent}}</p>
    </div>

    <p style="margin-top:18px">If this was you, no further action is required. If you do not recognize this sign-in, please <a href="https://stock-market-dev.vercel.app/" style="color:#FDD458; text-decoration:underline;">secure your account</a> immediately by changing your password and reviewing recent activity.</p>

    <a class="cta" href="https://stock-market-dev.vercel.app/">Open Signalist</a>
    <p style="margin-top:20px; font-size:12px; color:#6b7280">This is an automated message — do not reply. © Signalist</p>
  </div>
</body>
</html>`;
